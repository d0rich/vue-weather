...
export class Geocode{
    ...
    async getCountryCodeByCoords(coords = new Coords()){
        ...
        return res.data?.response?.GeoObjectCollection?.featureMember[0]?.GeoObject?.metaDataProperty?.GeocoderMetaData?.Address?.country_code
    }
